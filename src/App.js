    ...
    <Router>
      <Layout>
        <Routes>
          ...
          {!authCtx.isLoggedIn && <Route path="/forgotpassword" element={<ForgotPasswordForm />} />}
          {!authCtx.isLoggedIn && <Route path="/forgotpassword/update" element={<UpdatePasswordForm />} />}
          {authCtx.isLoggedIn && <Route path="/user/reset/password" element={<ResetPasswordForm />} />}
          {!authCtx.isLoggedIn && <Route path="/signup" element={<SignUpForm />} />}
          <Route path="/contact" element={<ContactPage />} />


          {authCtx.isLoggedIn && <React.Fragment>
            <Route path='/context/screenmodel' element={<ScreenModel />} />
            <Route path='/context/analysismodel' element={<AnalysisModel />} />
            <Route path='/context/investingstyle' element={<InvestingStyle />} />
            <Route path='/context/chartanalysis' element={<ContextFundamentalChart />} />

            <Route path='/dataanalysis/profile' element={<CompanyProfile />} />
            <Route path='/dataanalysis/fundamentalchart' element={<DAFundamentalChart />} />
            <Route path='/dataanalysis/financials' element={<DAFinancials />} />
            <Route path='/dataanalysis/historicaldata' element={<DAMarketData />} />
            <Route path='/dataanalysis/keymetrics' element={<DAKeyMetrics />} />
            <Route path='/dataanalysis/ranges' element={<DARanges />} />
            <Route path='/dataanalysis/linearregression' element={<DALinearRegression />} />
          ...
          {authCtx.isLoggedIn && authCtx.role === 'Admin' && <React.Fragment>
            <Route path='/dataprocessing/investingstyle' element={<DpInvestingStyle />} />
            <Route path='/dataprocessing/analysismodel' element={<DpAnalysisModel />} />
            <Route path='/dataprocessing/screenModel' element={<DpScreenModel />} />
            <Route path='/dataprocessing/ranges' element={<DataProcessingRanges />} />
            <Route path='/dataprocessing/createMetrics' element={<DPCreateMetrics />} />
            ...
            <Route path='/admin/manageContacts' element={<ContactsManagement />} />
          </React.Fragment>}
