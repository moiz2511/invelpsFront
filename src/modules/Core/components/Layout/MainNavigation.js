...
const pages = [{ label: 'Home', link: "/#home" }, { label: 'Solutions', link: "/#solutions" }, { label: 'Applications', link: "/#applications" }, { label: 'About us', link: "/#aboutus" }, { label: 'Contact', link: "/contact" }];
            ...
            >
                <Container maxWidth="xl">
                    ...
                    >
                        ...
                        <Box sx={{ display: { xs: "none", md: "flex" } }}>
                            ...
                            <ul className="navbar-list" style={{ justifyContent: "space-between"}}>
                                ...
                                {isUserLoggeIn &&
                                    <RouterLink to="/logout" onClick={() => { authCtx.logout() }} style={achorStyle}>
                                        Logout
                                    </RouterLink>
                                    // <Button
                                    //     key="logout"
                ...
                <Drawer
                    ...
                    sx={{
                        minWidth: 240,
                        flexShrink: 0,
                        [`& .MuiDrawer-paper`]: { minWidth: 240, boxSizing: 'border-box', backgroundColor: ColorConstants.APP_SIDE_NAV_BG_COLOR },
                    }}
                >
                    <List
                        sx={{ paddingTop: "95px", width: '100%', maxWidth: 240, bgcolor: ColorConstants.APP_SIDE_NAV_BG_COLOR, color: 'white' }}
                        component="nav"
                    >
                        {subNavItemsData.map((item) => {
                            if (item.isAdminNav && authCtx.role === 'Admin') {
                                if (item.children !== null | undefined && item.children.length > 0) {
                                    return (
