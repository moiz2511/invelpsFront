...
const AnalysisModel = () => {
    console.log(Constants.BACKEND_SERVER_BASE_URL);
    ...
    const onSubmitHandler = (event) => {
        ...
        console.log(stylesFilter, mentorFilter, screenModelFilter)
    ...
    async function getMentorDropDownByStyle() {
        const body = { "style": stylesFilter }
    ...
    async function getScreenModelDropDownByStyle() {
        const body = { "mentor": mentorFilter }
    ...
    return (
        <Grid container>
            <Grid container
                component="form"
                sx={{
                    '& .MuiTextField-root': { ml: 5, mt: 5, mr: 2, minWidth: '25ch' },
                }}
                noValidate
                autoComplete="off">
                <Grid item>
                ...
                <Grid item sx={{ mt: 5 }} style={{ display: "flex" }}>
                    <Button id="screenModelButton" type="submit" onClick={onSubmitHandler} variant="contained" href='https://www.google.com' size="medium"> Screen </Button>
                </Grid>
            </Grid>
            <EnhancedTable />
        </Grid>
