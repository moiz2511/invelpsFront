...
import DAFinancialNotesService from '../services/FinancialNotesService';
...
const DAFinancialNotes = () => {
    ...
    const onSubmitHandler = async (event) => {
        ...
        await restService.getDAFinancialNotesData({ company: companyFilter.company_name, table: tableFilter, from_year: fromFilter, to_year: toFilter })
            .then((response) => {
...
export default DAFinancialNotes;
