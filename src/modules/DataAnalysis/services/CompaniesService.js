...
export default class CompaniesService {
    ...
    getAllCategories = (type) => {
        return this.init().post("/getAllCategories", {table: type})
    }

    getProfileDataByCompanyAndTableName = (company, exchange) => {
        return this.init().post("/companies/profile", {company, exchange})
    } 
}
